public class A6_MathOperations {
    public static void main(String[] args) {
        ...
        System.out.println("The Andromeda Galaxy has " + (starsInAndromeda - starsInMilkyWay) + " mrore stars than the Milky Way");

        System.out.println("Snape made an error on his excel, accidentally multiplying Ron's score to: " + (testScore * 1.25) + "/10");
        System.out.println("Snape caught the error. Furious, he dividedr Ron's score to: " + (testScore / 2));
